...
import HandleSelectRole from "../Packets/PacketHandlers/HandleSelectRole";
import HandleEnterWorld from "../Packets/PacketHandlers/HandleEnterWorld";
import HandleWorldRequest from "../Packets/PacketHandlers/HandleWorldRequest";
...
class NetworkHandler {
	...
	private initPacketHandlers() {
		...
		this._requestHandler.Register(new HandleSelectRole());
		this._requestHandler.Register(new HandleEnterWorld());
		this._requestHandler.Register(new HandleWorldRequest());
	}
